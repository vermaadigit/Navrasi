      ...
      >
        ...
        <div className="bg-white border border-stone-200 rounded-sm shadow-sm p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-stone-600 font-light">Join our exclusive community</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full px-4 py-3 bg-stone-50 border rounded-sm focus:outline-none focus:border-stone-300 focus:bg-white transition-all font-light ${
              ...
              />
              {fieldErrors.name && (
                <p className="mt-1 text-sm text-red-600 font-light">{fieldErrors.name}</p>
              )}
            </div>
            ...
            <div>
              ...
              />
              {fieldErrors.email && (
                <p className="mt-1 text-sm text-red-600 font-light">{fieldErrors.email}</p>
              )}
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full px-4 py-3 bg-stone-50 border rounded-sm focus:outline-none focus:border-stone-300 focus:bg-white transition-all pr-12 font-light ${
